        ...
        <div class="form container p-4 mt-5">
            <div class="row">
                <div class="col-md-4 offset-md-4">    
                    <div class="card">
                        <div class="card-body">
                            <form action="./src/php/main/validation.php" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" name="Usuario" placeholder="Usuario..." class="w-100 p-2">
                                </div>
                                <div class="form-group">
                                    <input type="password" name="Password" placeholder="Password..." class="w-100 p-2">
                                </div>
                                <div class="form-group">
                                ...
                                <a href="./src/html/recovery.html">Olvide mi password</a>
                            </form>
                        </div>
                    </div>
                </div>
